...
{
    partial class V_AgregarSalidasEfectivo
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(V_AgregarSalidasEfectivo));
            panel2 = new Panel();
            ...
            panel2.Controls.Add(B_RegistrarSalida);
            ...
            pictureBox2.Location = new Point(191, 17);
            ...
            panel1.Location = new Point(105, 74);
            ...
            label1.Location = new Point(248, 17);
            label1.Name = "label1";
            ...
            TB_Monto.Location = new Point(202, 201);
            ...
            TB_Concepto.Location = new Point(112, 122);
            ...
            label5.Location = new Point(305, 169);
            label5.Name = "label5";
            ...
            label3.Location = new Point(291, 87);
            label3.Name = "label3";
            ...
            B_Cancelar.Location = new Point(371, 264);
            B_Cancelar.Margin = new Padding(3, 2, 3, 2);
            B_Cancelar.Name = "B_Cancelar";
            B_Cancelar.Size = new Size(208, 52);
            ...
            // B_RegistrarSalida
            // 
            B_RegistrarSalida.AutoSize = true;
            B_RegistrarSalida.BackColor = Color.FromArgb(26, 77, 128);
            B_RegistrarSalida.Font = new Font("Segoe UI Semibold", 13.8F, FontStyle.Bold);
            B_RegistrarSalida.ForeColor = Color.White;
            B_RegistrarSalida.Image = Properties.Resources.salvar1;
            B_RegistrarSalida.Location = new Point(144, 264);
            B_RegistrarSalida.Margin = new Padding(3, 2, 3, 2);
            B_RegistrarSalida.Name = "B_RegistrarSalida";
            B_RegistrarSalida.Size = new Size(208, 52);
            B_RegistrarSalida.TabIndex = 3;
            B_RegistrarSalida.Text = "Aceptar (Enter)";
            B_RegistrarSalida.TextAlign = ContentAlignment.MiddleRight;
            B_RegistrarSalida.TextImageRelation = TextImageRelation.ImageBeforeText;
            B_RegistrarSalida.UseVisualStyleBackColor = false;
            B_RegistrarSalida.Click += B_RegistrarSalida_Click;
            // 
            // V_AgregarSalidasEfectivo
            // 
            AcceptButton = B_RegistrarSalida;
            ...
            Name = "V_AgregarSalidasEfectivo";
            Text = "Registrar Salida de Efectivo";
        ...
        private Button B_RegistrarSalida;
