namespace POS_CHITOS.Reportes
{
    partial class V_ReporteVentas
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(V_ReporteVentas));
            panel1 = new Panel();
            B_Cancelar = new Button();
            B_Guardar = new Button();
            check_detallesventas = new CheckBox();
            label7 = new Label();
            check_ventascanceladas = new CheckBox();
            ...
            panel1.Controls.Add(check_detallesventas);
            panel1.Controls.Add(label7);
            panel1.Controls.Add(check_ventascanceladas);
            ...
            B_Cancelar.Location = new Point(413, 441);
            ...
            B_Guardar.Location = new Point(232, 441);
            ...
            // 
            // check_detallesventas
            // 
            check_detallesventas.AutoSize = true;
            check_detallesventas.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            check_detallesventas.Location = new Point(12, 348);
            check_detallesventas.Name = "check_detallesventas";
            check_detallesventas.Size = new Size(290, 32);
            check_detallesventas.TabIndex = 29;
            check_detallesventas.Text = "Incluir detalles de las ventas";
            check_detallesventas.UseVisualStyleBackColor = true;
            // 
            // label7
            // 
            ...
            label7.TabIndex = 28;
            // 
            // check_ventascanceladas
            // 
            check_ventascanceladas.AutoSize = true;
            check_ventascanceladas.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            check_ventascanceladas.Location = new Point(12, 386);
            check_ventascanceladas.Name = "check_ventascanceladas";
            check_ventascanceladas.Size = new Size(263, 32);
            check_ventascanceladas.TabIndex = 25;
            check_ventascanceladas.Text = "Incluir Ventas Canceladas";
            check_ventascanceladas.UseVisualStyleBackColor = true;
            // 
            // CB_Usuarios
            // 
            CB_Usuarios.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            CB_Usuarios.FormattingEnabled = true;
            CB_Usuarios.Location = new Point(12, 284);
            ...
            label3.Location = new Point(378, 143);
            label3.Name = "label3";
            ...
            DTP_Hasta.Location = new Point(378, 177);
            DTP_Hasta.Name = "DTP_Hasta";
            DTP_Hasta.Size = new Size(347, 34);
            DTP_Hasta.TabIndex = 20;
            // 
            // DTP_Desde
            // 
            DTP_Desde.Font = new Font("Segoe UI", 12F);
            DTP_Desde.Location = new Point(12, 177);
            ...
            label2.TabIndex = 1;
            label2.Text = "Parametros para reporte de ventas";
            // 
            // label1
            // 
            ...
            Name = "V_ReporteVentas";
            Text = "Parametros para generar reporte de ventas";
        ...
        private CheckBox check_detallesventas;
        private Label label7;
        private CheckBox check_ventascanceladas;
